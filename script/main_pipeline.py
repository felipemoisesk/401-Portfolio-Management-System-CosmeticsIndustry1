...
if x == 1:
    ...
    ds_brnc_19 = pd.read_excel("..\data_input\AF01_brasil_novoscanais_19_20.xlsx", na_values=list_missingvalues)
    # renomear colunas
    ds_brnc_19 = ds_brnc_19.rename(columns=dict_columns)
    # filtrar uma coluna (série)
    ds_brnc_19 = ds_brnc_19[ds_brnc_19['ANO'] == 2019]
    ...
    ds_brnc_19.to_excel("..\data_output\DS01_brnc_19.xlsx", index=False)
